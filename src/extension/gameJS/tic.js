...
function begin() {
    ...
    if (checkWin2()) ctx.fillText("You Win", canvas.width/2-50, canvas.height/2+canvas.width/12);
    if (checkFull()) ctx.fillText("Cats Game", canvas.width/2-50, canvas.height/2+canvas.width/12);
}
